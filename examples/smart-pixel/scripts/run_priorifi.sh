...
CUDA_VISIBLE_DEVICES=${CUDA_DEVICE} python fault_injection_campaign.py --config ${CONFIG} --pretrained-model ${PRETRAINED_MODEL} --model_id ${MODEL_ID}  --fic_output_dir ${FIC_OUTPUT_DIR} --bit_width ${BITWIDTH}
}
